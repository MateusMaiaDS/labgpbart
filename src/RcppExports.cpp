...
RcppExport SEXP _labgpbart_symm_distance_matrix(SEXP m1SEXP, SEXP phi_vectorSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _labgpbart_distance_matrix(SEXP m1SEXP, SEXP m2SEXP, SEXP phi_vectorSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type m1(m1SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_labgpbart_symm_distance_matrix", (DL_FUNC) &_labgpbart_symm_distance_matrix, 2},
    {"_labgpbart_distance_matrix", (DL_FUNC) &_labgpbart_distance_matrix, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_labgpbart(DllInfo *dll) {
